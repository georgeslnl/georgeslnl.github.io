    ...
    return (
        <div className="flex gap-3 items-center">
            ...
            <a href="https://www.linkedin.com/in/georgeslinel/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className="text-text-900 hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
                <IoMail className="text-text-900 text-3xl hover:text-primary-500" />
                {showEmail && (
                    <p className="text-text-900 text-xl font-semibold">
