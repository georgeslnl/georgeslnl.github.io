...
export default function SkillsCard() {
    return (
        <div className="lg:col-span-2 lg:col-start-3 lg:row-start-4 hover:shadow-md m-auto bg-background-200 p-8 rounded-2xl flex flex-col gap-1 items-end">
            ...
            <h1 className="text-3xl font-semibold text-text-900 text-end">Skills</h1>
            </div>
            <p className="text-text-900 text-justify">I am the most familiar in Python and Javascript/Typescript. 
