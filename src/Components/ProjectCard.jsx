...
const ProjectCard = ({ project }) => {
    return (
        <Link to={`/projects/${project.id}`} className="block">
            <div className="flex flex-col gap-4 rounded-lg p-6 w-full h-full bg-secondary-50 hover:bg-secondary-100 shadow-xl hover:shadow-2xl border transition-all duration-300">
