...
const About = () => {
  return (
    <div className="flex flex-col">
      ...
      <motion.div
        className="flex flex-col gap-6 text-text text-sm  lg:text-base  lg:w-3/4"
        variants={{
      ...
      >
        <img src={georges} alt="Georges Linel" className="w-3/4 lg:w-1/2 border" />
        ...
        <div className="flex items-center gap-4 text-primary text-xl  lg:text-3xl">
          <a 
